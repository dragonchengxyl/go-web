      ...
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-0.5 text-sm text-white/50 line-clamp-2">{group.description}</p>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-4xl">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/groups/create">
            <Button className="bg-purple-600 hover:bg-purple-500 text-white">+ 创建圈子</Button>
          </Link>
        </div>
        ...
        {tab === 'discover' && (
          <form onSubmit={handleSearch} className="flex gap-2 mb-6">
            <input
              ...
              placeholder="搜索圈子名称…"
            />
            <Button type="submit" variant="outline" className="border-white/20 text-white/70">
              搜索
            </Button>
          </form>
        )}
