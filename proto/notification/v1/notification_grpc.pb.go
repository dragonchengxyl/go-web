...
type NotificationServiceClient interface {
	...
	StreamUserNotifications(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Notification], error)
}
...
func (c *notificationServiceClient) MarkRead(ctx context.Context, in *MarkReadRequest, opts ...grpc.CallOption) (*v1.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.Empty)
...
func (c *notificationServiceClient) StreamUserNotifications(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Notification], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &NotificationService_ServiceDesc.Streams[0], NotificationService_StreamUserNotifications_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[UserRequest, Notification]{ClientStream: stream}
...
type NotificationService_StreamUserNotificationsClient = grpc.ServerStreamingClient[Notification]
...
type NotificationServiceServer interface {
	...
	StreamUserNotifications(*UserRequest, grpc.ServerStreamingServer[Notification]) error
...
func (UnimplementedNotificationServiceServer) MarkRead(context.Context, *MarkReadRequest) (*v1.Empty, error) {
...
func (UnimplementedNotificationServiceServer) StreamUserNotifications(*UserRequest, grpc.ServerStreamingServer[Notification]) error {
	return status.Error(codes.Unimplemented, "method StreamUserNotifications not implemented")
}
...
func _NotificationService_StreamUserNotifications_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(NotificationServiceServer).StreamUserNotifications(m, &grpc.GenericServerStream[UserRequest, Notification]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type NotificationService_StreamUserNotificationsServer = grpc.ServerStreamingServer[Notification]
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _NotificationService_StreamUserNotifications_Handler,
			ServerStreams: true,
		},
	},
